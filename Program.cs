...
8.Конец");
    ...
    2.Ввод с клавиатуры");
        ...
        static int[][] CreateArrManually(int strings)
        {
            ...
            for (int i = 0;i < strings; i++)
            {
                int coloums = ReadInt($"Введите количество элементов в строке {i + 1}: ");
                ...
                switch (answer) 
                {
                    case 1://создание и вывод двумерного массива
                        ...
                        switch (option)
                        {
                            case 1:
                                Console.WriteLine();
                                matr = CreateMatr(stringsMatr, columnsMatr);
                                PrintMatr(matr, "Массив: ");
                                break;
                            case 2:
                                Console.WriteLine();
                                matr = CreateMatrManually(stringsMatr, columnsMatr);
                                PrintMatr(matr, "Массив: ");
                                Console.WriteLine();
                                break;
                        }
                    ...
                    case 2://удаление чётных строк
                        if (!IsEmpty(matr))
                        {
                            int newStrings = (stringsMatr + 1) / 2;
                    ...
                    case 3://формирование и вывод рваного массива
                        ...
                        switch (options)
                        {
                            case 1:
                                Console.WriteLine();
                                array = CreateArr(stringsArray);
                                PrintArr(array,"Массив:");
                                Console.WriteLine();
                                break;
                            case 2:
                                Console.WriteLine();
                                array = CreateArrManually(stringsArray);
                                PrintArr(array, "Массив:");
                                Console.WriteLine();
                                break;
                        }
                    ...
                    case 4://добавление строки в конце массива
                        int newString = ReadInt("Введите количесвто элементов добавляемой строки'"); ;
                        int[] line = new int[0];
                        ...
                        {
                            case 1:
                                line = CreateLine(newString);
                                break;
                            case 2:
                                line = CreateLineManually(newString);
                                break;
                        }
